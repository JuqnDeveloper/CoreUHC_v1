...
class UHCTeamTask extends PluginTask
{
    ...
    public function onRun($tick)
    {
        ...
        if($status == "grace"){
            ...
            if($this->pvp <= 1){
                ...
                foreach ($arena->getPlayersEveryone() as $player) {
                    if ($player->isOnline()) {
                        $player->getInstance()->sendMessage(TextFormat::BOLD . TextFormat::DARK_GRAY . "[ " . TextFormat::RESET . TextFormat::BLUE . "Compact" . TextFormat::GOLD . "UHC " . TextFormat::BOLD . TextFormat::DARK_GRAY . "] " . TextFormat::RESET);
                    }
                }
            }
            foreach ($arena->getPlayersEveryone() as $player) {
